...
const TermsAndPolicySocial = () => {
  ...
  const handleSubmit = () => {
    if (!isTermsOfUseChecked) {
      ...
      openModal({
        primaryText:
          '만 14세 미만은 가입이 불가능합니다. 만 14세 이상임을 확인해주세요.',
        type: 'warning',
        isAutoClose: false,
        onConfirm: () => {
          closeModal(), setModalOpen(false);
      ...
      <div className="flex flex-col items-center justify-start">
        <div className="w-full max-w-2xl p-8">
          ...
          <div className="flex flex-col text-left w-full border border-primary p-3 max-h-48 overflow-y-scroll">
            ...
            <span className="pt-3">
              본 이용약관은 “사이트명”(이하 "사이트")의 서비스의 이용조건과
            ...
            <span className="pt-3">
              ...
              노출된 정보에 대해 운영자는 일체의 책임을 지지 않습니다.
            </span>
            <span className="pt-3">
          ...
          <div className="flex flex-col text-left w-full border border-primary p-3 max-h-48 overflow-y-scroll">
            ...
            <span className="pt-1">
              이메일, 비밀번호, 휴대폰 번호, 업체명, 대표자명, 회사 및 팩스
              번호, 주소
            </span>
