...
const TermsAndPolicyNonSocial = () => {
  const { navigateTo, routes } = useNavigateTo();
  const [isAllChecked, setIsAllChecked] = useState(false);
  const [isTermsOfUseChecked, setIsTermsOfUseChecked] = useState(false);
  const [isPrivacyPolicyChecked, setIsPrivacyPolicyChecked] = useState(false);
  const [isUpper14AgeChecked, setIsUpper14AgeChecked] = useState(false);
  ...
  const handleAllCheckboxChange = (e) => {
    ...
    setIsTermsOfUseChecked(isChecked);
    setIsPrivacyPolicyChecked(isChecked);
    setIsUpper14AgeChecked(isChecked);
  };

  const handleTermsOfUseCheckboxChange = (e) => {
    const isChecked = e.target.checked;
    setIsTermsOfUseChecked(isChecked);
    setIsAllChecked(isChecked && isPrivacyPolicyChecked && isUpper14AgeChecked);
  };

  const handlePrivacyPolicyCheckboxChange = (e) => {
    const isChecked = e.target.checked;
    setIsPrivacyPolicyChecked(isChecked);
    setIsAllChecked(isChecked && isTermsOfUseChecked && isUpper14AgeChecked);
  };

  const handleUpper14AgeCheckboxChange = (e) => {
    const isChecked = e.target.checked;
    setIsUpper14AgeChecked(isChecked);
    setIsAllChecked(isChecked && isTermsOfUseChecked && isPrivacyPolicyChecked);
  };
  ...
  const handleSubmit = () => {
    if (!isTermsOfUseChecked) {
      setModalOpen(true);
      openModal({
        primaryText: '이용 약관에 동의하셔야 가입이 가능합니다.',
        type: 'warning',
        isAutoClose: false,
        onConfirm: () => {
      ...
      setModalOpen(true);
      openModal({
        primaryText: '개인정보 처리방침에 동의하셔야 가입이 가능합니다.',
        type: 'warning',
        isAutoClose: false,
        onConfirm: () => {
          closeModal(), setModalOpen(false);
    ...
    } else if (!isUpper14AgeChecked) {
      setModalOpen(true);
      openModal({
        primaryText: '만 14세 미만은 가입이 불가능합니다.\n만 14세 이상임을 확인해주세요.',
        type: 'warning',
        isAutoClose: false,
        onConfirm: () => {
          closeModal(), setModalOpen(false);
      ...
      <div className="flex flex-col items-center justify-start">
        <div className="w-full max-w-2xl p-8">
          ...
          <div className="flex items-start mt-6 mb-3">
            ...
            />
            <label htmlFor="all-agree" className="text-sm text-gray-700">
              이용약관, 개인정보 수집 및 이용, 만 14세 이상임에 모두 동의합니다.
            </label>
          </div>
          ...
          <div className="flex items-start mt-6 mb-3">
            <input
              type="checkbox"
              id="terms-of-use-agree"
              className="mr-2 mt-1"
              checked={isTermsOfUseChecked}
              onChange={handleTermsOfUseCheckboxChange}
            />
            <label htmlFor="terms-of-use-agree" className="text-sm text-gray-700">
              이용약관 동의
            </label>
          </div>
          <div className="flex flex-col text-left w-full border border-primary p-3 max-h-48 overflow-y-scroll">
            <span className="font-bold">제1조 목적</span>
            <span className="pt-3">
              본 이용약관은 “사이트명”(이하 "사이트")의 서비스의 이용조건과 운영에 관한 제반 사항 규정을 목적으로 합니다.
            </span>

            <span className="font-bold pt-5">제2조 용어의 정의</span>
            <span className="pt-3">본 약관에서 사용되는 주요한 용어의 정의는 다음과 같습니다.</span>
            <span className="pt-1">
            ...
            <span className="font-bold pt-5">제3조 약관 외 준칙</span>
            <span className="pt-3">
              운영자는 필요한 경우 별도로 운영정책을 공지 안내할 수 있으며, 본 약관과 운영정책이 중첩될 경우 운영정책이 우선 적용됩니다.
            </span>

            <span className="font-bold pt-5">제4조 이용계약 체결</span>
            <span className="pt-3">
            ...
            <span className="font-bold pt-5">제5조 서비스 이용 신청</span>
            <span className="pt-3">
            ...
            <span className="font-bold pt-5">제6조 개인정보처리방침</span>
            <span className="pt-3">
              사이트 및 운영자는 회원가입 시 제공한 개인정보 중 비밀번호를 가지고 있지 않으며 이와 관련된 부분은 사이트의 개인정보처리방침을 따릅니다. 운영자는 관계 법령이 정하는 바에 따라 회원등록정보를 포함한 회원의 개인정보를 보호하기 위하여 노력합니다.
            </span>
            <span className="pt-3">
            ...
            <span className="font-bold pt-5">제7조 운영자의 의무</span>
            <span className="pt-3">
            ...
            <span className="font-bold pt-5">제8조 회원의 의무</span>
            <span className="pt-3">
            ...
            <span className="pt-3">④ 회원은 운영자와 사이트 및 제3자의 지적 재산권을 침해해서는 안 됩니다.</span>

            <span className="font-bold pt-5">제9조 서비스 이용 시간</span>
            <span className="pt-3">
            ...
            <span className="pt-3">
              ...
              <ul className="pl-6 list-disc pt-3">
            ...
            <span className="font-bold pt-5">제10조 서비스 이용 해지</span>
            <span className="pt-3">
            ...
            <span className="font-bold pt-5">제11조 서비스 이용 제한</span>
            <span className="pt-3">
            ...
            <span className="font-bold pt-5">제12조 게시물의 관리</span>
            <span className="pt-3">
            ...
            <span className="pt-3">③ 불량게시물의 판단기준은 다음과 같습니다.</span>
            <ul className="pl-6 list-disc pt-3">
            ...
            <span className="font-bold pt-5">제13조 게시물의 보관</span>
            <span className="pt-3">
              사이트 운영자가 불가피한 사정으로 본 사이트를 중단하게 될 경우, 회원에게 사전 공지를 하고 게시물의 이전이 쉽도록 모든 조치를 하기 위해 노력합니다.
            </span>

            <span className="font-bold pt-5">제14조 게시물에 대한 저작권</span>
            <span className="pt-3">
            ...
            <span className="font-bold pt-5">제15조 손해배상</span>
            <span className="pt-3">
            ...
            <span className="font-bold pt-5">제16조 면책</span>
            <span className="pt-3">
            ...
            <span className="font-bold pt-5">부칙</span>
            <span className="pt-3">이 약관은 2024.11.15부터 시행합니다.</span>
          </div>
          ...
          <div className="flex items-start mt-6 mb-3">
            ...
            />
            <label htmlFor="privacy-policy-agree" className="text-sm text-gray-700">
              개인정보 수집 및 이용 동의
            </label>
          </div>
          <div className="flex flex-col text-left w-full border border-primary p-3 max-h-48 overflow-y-scroll">
            <span className="font-bold">1. 개인정보 수집목적 및 이용목적</span>
            <span className="pt-3">(1) 홈페이지 회원 가입 및 관리</span>
            <span className="pl-3 pt-1">
              회원 가입 의사 확인, 회원제 서비스 제공에 따른 본인 식별․인증, 회원자격 유지․관리,
              제한적 본인확인제 시행에 따른 본인확인, 서비스 부정 이용 방지, 만 14세 미만 아동의 개인정보처리 시 법정대리인의 동의 여부 확인, 각종 고지․통지, 고충 처리 등의 목적
            </span>
            <span className="pt-3">(2) 재화 또는 서비스 제공</span>
            <span className="pl-3 pt-1">
              물품 배송, 서비스 제공, 계약서 및 청구서 발송, 콘텐츠 제공, 맞춤서비스 제공, 본인인증, 연령인증, 요금 결제 및 정산, 채권추심 등의 목적
            </span>
            <span className="pt-3">(3) 고충 처리</span>
            <span className="pl-3 pt-1">
              민원인의 신원 확인, 민원사항 확인, 사실조사를 위한 연락․통지, 처리 결과 통보 등의 목적
            </span>
            <span className="font-bold pt-5">2. 수집하는 개인정보 항목</span>
            <span className="pt-1">이메일, 비밀번호, 휴대폰 번호, 업체명, 대표자명, 회사 및 팩스 번호, 주소</span>
            <span className="font-bold pt-5">3. 개인정보 보유 및 이용기간</span>
            <span className="pt-1">
          ...
          <div className="flex items-start mt-6">
            <input
              type="checkbox"
              id="upper-14-age-agree"
              className="mr-2 mt-1"
              checked={isUpper14AgeChecked}
              onChange={handleUpper14AgeCheckboxChange}
            />
            <label htmlFor="upper-14-age-agree" className="text-sm text-gray-700">
              만 14세 이상입니다.
            </label>
          </div>

          {/* 회원가입하러 가기 버튼 */}
          <div className="flex flex-col items-center px-3 py-2 mt-6">
            <button
              type="button"
...
export default TermsAndPolicyNonSocial;
